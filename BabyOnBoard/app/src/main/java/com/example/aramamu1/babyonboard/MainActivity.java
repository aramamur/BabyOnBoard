...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            if ((uname != null) && !uname.isEmpty()) {
                ...
                textResponse.setText("Welcome!"+System.getProperty("line.separator")+ uname+" is "+ uweek + " weeks or "+nummon+" months.");
                ...
                textResponse.setText("Welcome to Baby on Board!"+System.getProperty("line.separator")+"Current Date: "+current_date);
                appttext.setText("");
            }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        } else if (id == R.id.nav_healthMilestone) {
            if(uid != 0) {
                Intent intent = new Intent(this, TrackHealthMilestone.class);
                startActivity(intent);
            }
            else{
                textResponse.setText("Please login to access this content!");
