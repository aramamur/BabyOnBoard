...
public class MyDBHandler extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "bb2.db";
    public static final String TABLE_USERS = "users";
    public static final String COLUMN_ID = "UserID";
    public static final String COLUMN_NAME = "UserName";
    public static final String COLUMN_NAME1 = "UserPswd";
    public static final String COLUMN_NAME2 = "birthDate";
    ...
    public static final String COLUMN_NAME23 = "Height";
    public static final String COLUMN_NAME24 = "HeadCircum";
    public static final String COLUMN_NAME25 = "NumDiaper";
    public static final String COLUMN_NAME26 = "NumMilk";
    public static final String COLUMN_NAME27 = "NumSolid";
    ...
    public void onCreate(SQLiteDatabase db) {
       ...
       //         + " INTEGER, "+ COLUMN_NAME24 + " INTEGER "+")";
        String CREATE_HEALTH_TABLE = "CREATE TABLE " +
                TABLE_HEALTH + "(" + COLUMN_ID2 + " INTEGER PRIMARY KEY AUTOINCREMENT," + COLUMN_NAME20
                + " INTEGER, " + COLUMN_NAME21 + " TEXT, "+ COLUMN_NAME22 + " INTEGER, "+ COLUMN_NAME23
                + " INTEGER, "+ COLUMN_NAME24 + " INTEGER,"+ COLUMN_NAME25 + " INTEGER, "+ COLUMN_NAME26 + " INTEGER, "+ COLUMN_NAME27 + " INTEGER "+")";
    ...
    //for health table
    //add
    public void addHealthMilestoneHandler(HealthMilestone hm) {
        ContentValues values = new ContentValues();
        values.put(COLUMN_NAME20, hm.getUserID());
        values.put(COLUMN_NAME21, hm.getDate());
        values.put(COLUMN_NAME22, hm.getWeight());
        values.put(COLUMN_NAME23, hm.getHeight());
        values.put(COLUMN_NAME24, hm.getHeadCircum());
        values.put(COLUMN_NAME25, hm.getNumDiapers());
        values.put(COLUMN_NAME26, hm.getNumMilk());
        values.put(COLUMN_NAME27, hm.getNumSolid());
        SQLiteDatabase db = this.getWritableDatabase();
    ...
    public String loadHealthHandler(int userid) {
        ...
        if (cursor.moveToFirst()) {
            ...
            int result_7 = cursor.getInt(7);
            int result_8 = cursor.getInt(8);
            result += "User ID: "+String.valueOf(result_1) + " Date: " + result_2 + " Weight: " + String.valueOf(result_3) +" Height: " + String.valueOf(result_4) +" Head Circumference: "+ String.valueOf(result_5) +" Num Diapers: "+ String.valueOf(result_6) +" Num Milk: "+ String.valueOf(result_7) +" Num Solids: "+ String.valueOf(result_8) +" "+
            ...
            while (cursor.moveToNext()) {
                ...
                result_6 = cursor.getInt(6);
                result_7 = cursor.getInt(7);
                result_8 = cursor.getInt(8);
                result += "User ID: "+String.valueOf(result_1) + " Date: " + result_2 + " Weight: " + String.valueOf(result_3) +" Height: " + String.valueOf(result_4) +" Head Circumference: "+ String.valueOf(result_5) +" Num Diapers: "+ String.valueOf(result_6) +" Num Milk: "+ String.valueOf(result_7) +" Num Solids: "+ String.valueOf(result_8) +" "+
                        System.getProperty("line.separator");
            }
            cursor.close();
    ...
    public void addHandler(User user) {
        ...
        values.put(COLUMN_NAME2, user.getbirthDate());
    ...
    public String loadHandler() {
        ...
        while (cursor.moveToNext()) {
            ...
            result += "User ID: "+String.valueOf(result_0) + " Name: " + result_1 + " Password: " + result_2 + " Birth Date: " + result_3 +" Initial Weight: " + result_4 +
                    System.getProperty("line.separator");
        }
        cursor.close();
        db.close();
    ...
    public boolean deleteHandler(int userid) {
        ...
        HealthMilestone hm = new HealthMilestone();
        if (cursor2.moveToFirst()) {
            hm.setUserID(Integer.parseInt(cursor2.getString(1)));

            db2.delete(TABLE_HEALTH, COLUMN_NAME20 + "=?",
                    new String[] {
                            String.valueOf(hm.getUserID())
                    });
            cursor2.close();
            result3 = true;
        }
